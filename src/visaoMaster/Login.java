...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabelDesenvolvimento = new javax.swing.JLabel();
        ...
        setTitle("Sistema de Controle de Tráfego");
        ...
        jLabel1.setText("INSTITUTO MIRIM DE CAMPO GRANDE");
        ...
        jLabelUsuario.setText("Sistema de Controle de Tráfego");
        getContentPane().add(jLabelUsuario);
        jLabelUsuario.setBounds(350, 410, 220, 20);

        jLabelDesenvolvimento.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/loguin_Desenvolvimento.png"))); // NOI18N
        getContentPane().add(jLabelDesenvolvimento);
        jLabelDesenvolvimento.setBounds(0, 410, 340, 50);
        ...
        jLabelNameSetor.setBounds(580, 430, 260, 30);
        ...
        jLabelFaixaInfeior.setBounds(-250, 410, 1040, 60);
    ...
    private void jLabel2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel2MouseClicked
        ...
        dispose();
                ...
                && model.getSenha().equals(jPasswordFieldSenha.getText())
                && jTextFieldUser.getText().length() > 0){
        visaoUsuario.MenuPrincipal menu = new visaoUsuario.MenuPrincipal(jTextFieldUser.getText());
        menu.setVisible(true);
        dispose();
        }
    ...
    private javax.swing.JLabel jLabelDesenvolvimento;
