 ...
 * @author Professor
 */
public class RelRegPorAtividade extends javax.swing.JFrame {
     ...
     */
    public RelRegPorAtividade() {
        initComponents();
        CbAtividade();
        jInternalFrameAtvPorAtv.setVisible(false);
    }
    ...
    public void CbAtividade(){
        ...
        conex.conexao();
        conex.executaSql("select descricao from tbl_tipoatividade order by descricao");
        try{
            conex.rs.first();
            ...
            JOptionPane.showMessageDialog(rootPane, "Registre os atividades da empresa nas Tabelas Aux.");
    ...
    private void initComponents() {
        ...
        jInternalFrameAtvPorAtv = new javax.swing.JInternalFrame();
        jScrollPaneBAtv = new javax.swing.JScrollPane();
        jTableBAtv = new javax.swing.JTable();
        ...
        jInternalFrameAtvPorAtv.setTitle("Atividades por Tipo de Atividade");
        jInternalFrameAtvPorAtv.setVisible(true);
        jInternalFrameAtvPorAtv.getContentPane().setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jTableBAtv.setFont(new java.awt.Font("Tahoma", 0, 9)); // NOI18N
        jTableBAtv.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {},
                {},
                {},
        ...
        jTableBAtv.setGridColor(new java.awt.Color(255, 255, 255));
        jTableBAtv.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jTableBAtvMouseClicked(evt);
            }
        });
        jScrollPaneBAtv.setViewportView(jTableBAtv);

        jInternalFrameAtvPorAtv.getContentPane().add(jScrollPaneBAtv, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 30, 570, 260));
        ...
        jLabelRegSelecionado.setText("ATIVIDADE:");
        jInternalFrameAtvPorAtv.getContentPane().add(jLabelRegSelecionado, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 0, -1, 20));
        ...
        jInternalFrameAtvPorAtv.getContentPane().add(jTextFieldRegSelecionado, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 0, 170, 20));
        ...
        jInternalFrameAtvPorAtv.getContentPane().add(jButtonSairIF, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 0, 45, 30));
        ...
        jInternalFrameAtvPorAtv.getContentPane().add(jButtonImprimir1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 45, 30));
        ...
        jInternalFrameAtvPorAtv.getContentPane().add(JlabelFundoMenuIF, new org.netbeans.lib.awtextra.AbsoluteConstraints(-10, 30, 610, 290));
        ...
        jInternalFrameAtvPorAtv.getContentPane().add(jLabelFaixaMenu1, new org.netbeans.lib.awtextra.AbsoluteConstraints(-400, 0, 1020, 60));

        getContentPane().add(jInternalFrameAtvPorAtv);
        jInternalFrameAtvPorAtv.setBounds(0, 30, 570, 320);
        ...
        jLabelAtividade.setBounds(10, 40, 90, 25);
        ...
        jTextFieldSetorAt.setBounds(100, 140, 410, 25);
        ...
        jComboBoxAtividade.setBounds(100, 40, 410, 25);
    ...
    private void jTableBAtvMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableBAtvMouseClicked
       String cod = ""+jTableBAtv.getValueAt(jTableBAtv.getSelectedRow(), 0);
    ...
    private void jButtonPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonPesquisarActionPerformed
        ...
        control.PesquisarAtividade(mod);
        jTextFieldRegSelecionado.setText(mod.getAtividade());
        
        PreencherTabela("select a.id_regatividade as id, a.dtativ, b.nomemotorista, a.setoratendido, c.descricao as desc from tbl_reg_ativ as a inner join tbl_motorista as b \n" 
              ...
              + "on(a.id_veiculo = d.id_veiculo) where descricao ilike'%"+ mod.getAtividade()+"%' order by a.id_regatividade desc");// 
    ...
    public void PreencherTabela(String SQL){
      ...
      try{
          ...
          JOptionPane.showMessageDialog(rootPane, "O tipo de atividade não possuí registros"); 
        }
      
      BeansTabelas modelo = new BeansTabelas(dados, colunas);
      
      jTableBAtv.setModel(modelo);
      jTableBAtv.getColumnModel().getColumn(0).setPreferredWidth(30);
      jTableBAtv.getColumnModel().getColumn(0).setResizable(false);
      jTableBAtv.getColumnModel().getColumn(0).setHeaderValue("ID");
      jTableBAtv.getColumnModel().getColumn(1).setPreferredWidth(60);
      jTableBAtv.getColumnModel().getColumn(1).setResizable(false); //não redimensionaveL
      jTableBAtv.getColumnModel().getColumn(1).setHeaderValue("DATA");
      jTableBAtv.getColumnModel().getColumn(2).setPreferredWidth(110);
      jTableBAtv.getColumnModel().getColumn(2).setResizable(false);
      jTableBAtv.getColumnModel().getColumn(2).setHeaderValue("MOTORISTA");
      jTableBAtv.getColumnModel().getColumn(3).setPreferredWidth(110);
      jTableBAtv.getColumnModel().getColumn(3).setResizable(false);
      jTableBAtv.getColumnModel().getColumn(3).setHeaderValue("SETOR");
      jTableBAtv.getColumnModel().getColumn(4).setPreferredWidth(237);
      jTableBAtv.getColumnModel().getColumn(4).setResizable(false);
      jTableBAtv.getColumnModel().getColumn(4).setHeaderValue("ATIVIDADE");

      jTableBAtv.getTableHeader().setReorderingAllowed(false); //não reordenavel
      jTableBAtv.setAutoResizeMode(jTableBAtv.AUTO_RESIZE_OFF); //não redmencionar
      jTableBAtv.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);//selicioar um dado por vez
    }
    ...
    private javax.swing.JInternalFrame jInternalFrameAtvPorAtv;
    ...
    private javax.swing.JScrollPane jScrollPaneBAtv;
    private javax.swing.JTable jTableBAtv;
