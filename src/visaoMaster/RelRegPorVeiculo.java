 ...
 * @author Professor
 */
public class RelRegPorVeiculo extends javax.swing.JFrame {
     ...
     */
    public RelRegPorVeiculo() {
        initComponents();
        CbPlaca();
        jInternalFrameAtvPorPlaca.setVisible(false);
    }
    ...
    public void CbPlaca(){
        ...
        conex.conexao();
        conex.executaSql("select placa from tbl_veiculo order by placa");
        try{
            conex.rs.first();
            jComboBoxPlaca.removeAllItems();
            do{
                jComboBoxPlaca.addItem(conex.rs.getString("placa").toUpperCase());
            }while(conex.rs.next());
    ...
    private void initComponents() {
        ...
        jInternalFrameAtvPorPlaca = new javax.swing.JInternalFrame();
        jScrollPaneBplaca = new javax.swing.JScrollPane();
        jTableBplaca = new javax.swing.JTable();
        ...
        setTitle("Atividades por placa");
        setResizable(false);
        getContentPane().setLayout(null);

        jInternalFrameAtvPorPlaca.setTitle("Atividades por Placa");
        jInternalFrameAtvPorPlaca.setVisible(true);
        jInternalFrameAtvPorPlaca.getContentPane().setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jTableBplaca.setFont(new java.awt.Font("Tahoma", 0, 9)); // NOI18N
        jTableBplaca.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {},
                {},
                {},
        ...
        jTableBplaca.setGridColor(new java.awt.Color(255, 255, 255));
        jTableBplaca.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jTableBplacaMouseClicked(evt);
            }
        });
        jScrollPaneBplaca.setViewportView(jTableBplaca);

        jInternalFrameAtvPorPlaca.getContentPane().add(jScrollPaneBplaca, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 30, 570, 260));
        ...
        jLabelRegSelecionado.setText("PLACA:");
        jInternalFrameAtvPorPlaca.getContentPane().add(jLabelRegSelecionado, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 0, -1, 20));
        ...
        jInternalFrameAtvPorPlaca.getContentPane().add(jTextFieldRegSelecionado, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 0, 100, 20));
        ...
        jInternalFrameAtvPorPlaca.getContentPane().add(jButtonSairIF, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 0, 45, 30));
        ...
        jInternalFrameAtvPorPlaca.getContentPane().add(jButtonImprimir1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 45, 30));
        ...
        jInternalFrameAtvPorPlaca.getContentPane().add(JlabelFundoMenuIF, new org.netbeans.lib.awtextra.AbsoluteConstraints(-10, 30, 610, 290));
        ...
        jInternalFrameAtvPorPlaca.getContentPane().add(jLabelFaixaMenu1, new org.netbeans.lib.awtextra.AbsoluteConstraints(-400, 0, 1020, 60));

        getContentPane().add(jInternalFrameAtvPorPlaca);
        jInternalFrameAtvPorPlaca.setBounds(0, 10, 580, 320);
        ...
        jTextFieldAtividade.setBounds(100, 110, 410, 25);
        ...
        jLabelPlaca.setBounds(60, 40, 40, 25);
        ...
        jTextFieldMotorista.setBounds(100, 80, 410, 25);
        ...
        jLabelMarca.setBounds(210, 40, 50, 20);
        ...
        jLabelModelo.setBounds(340, 40, 60, 20);
        ...
        jTextFieldModelo.setBounds(260, 40, 130, 20);
        ...
        jTextFieldMarca.setBounds(400, 40, 130, 20);
        ...
        jLabelMotorista.setBounds(40, 80, 60, 25);

        jComboBoxPlaca.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        ...
        jComboBoxPlaca.setBounds(100, 40, 110, 25);
    ...
    private void jTableBplacaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableBplacaMouseClicked
       String cod = ""+jTableBplaca.getValueAt(jTableBplaca.getSelectedRow(), 0);
    ...
    private void jButtonPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonPesquisarActionPerformed
        ...
        control.PesquisarPlaca(mod);
        jTextFieldRegSelecionado.setText(mod.getPlaca());
        ...
        PreencherTabela("select a.id_regatividade as id, a.dtativ, b.nomemotorista, a.setoratendido, c.descricao as desc from tbl_reg_ativ as a inner join tbl_motorista as b \n" 
              ...
              + "on(a.id_veiculo = d.id_veiculo) where placa ilike'%"+ mod.getPlaca()+"%' order by a.id_regatividade desc");// 
    ...
    public void PreencherTabela(String SQL){
      ...
      try{
          ...
          JOptionPane.showMessageDialog(rootPane, "O veículo não possuí atividades registradas"); 
        }
      
      BeansTabelas modelo = new BeansTabelas(dados, colunas);
      
      jTableBplaca.setModel(modelo);
      jTableBplaca.getColumnModel().getColumn(0).setPreferredWidth(30);
      jTableBplaca.getColumnModel().getColumn(0).setResizable(false);
      jTableBplaca.getColumnModel().getColumn(0).setHeaderValue("ID");
      jTableBplaca.getColumnModel().getColumn(1).setPreferredWidth(60);
      jTableBplaca.getColumnModel().getColumn(1).setResizable(false); //não redimensionaveL
      jTableBplaca.getColumnModel().getColumn(1).setHeaderValue("DATA");
      jTableBplaca.getColumnModel().getColumn(2).setPreferredWidth(110);
      jTableBplaca.getColumnModel().getColumn(2).setResizable(false);
      jTableBplaca.getColumnModel().getColumn(2).setHeaderValue("MOTORISTA");
      jTableBplaca.getColumnModel().getColumn(3).setPreferredWidth(110);
      jTableBplaca.getColumnModel().getColumn(3).setResizable(false);
      jTableBplaca.getColumnModel().getColumn(3).setHeaderValue("SETOR");
      jTableBplaca.getColumnModel().getColumn(4).setPreferredWidth(237);
      jTableBplaca.getColumnModel().getColumn(4).setResizable(false);
      jTableBplaca.getColumnModel().getColumn(4).setHeaderValue("ATIVIDADE");

      jTableBplaca.getTableHeader().setReorderingAllowed(false); //não reordenavel
      jTableBplaca.setAutoResizeMode(jTableBplaca.AUTO_RESIZE_OFF); //não redmencionar
      jTableBplaca.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);//selicioar um dado por vez
    }
    ...
    private javax.swing.JComboBox jComboBoxPlaca;
    ...
    private javax.swing.JInternalFrame jInternalFrameAtvPorPlaca;
    ...
    private javax.swing.JScrollPane jScrollPaneBplaca;
    private javax.swing.JTable jTableBplaca;
