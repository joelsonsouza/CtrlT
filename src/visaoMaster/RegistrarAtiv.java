...
public class RegistrarAtiv extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jInternalFrameBuscaPlaca.getContentPane().setLayout(null);
        ...
        jInternalFrameBuscaPlaca.getContentPane().add(jScrollPanePlaca);
        jScrollPanePlaca.setBounds(0, 30, 470, 180);
        ...
        jInternalFrameBuscaPlaca.getContentPane().add(jButtonSairIF);
        jButtonSairIF.setBounds(60, 0, 45, 30);
        ...
        jInternalFrameBuscaPlaca.getContentPane().add(jButtonPesquisarIF);
        jButtonPesquisarIF.setBounds(10, 0, 45, 30);
        ...
        jInternalFrameBuscaPlaca.getContentPane().add(jLabelFaixaMenu1);
        jLabelFaixaMenu1.setBounds(0, 0, 770, 30);
        ...
        jInternalFrameBuscaPlaca.getContentPane().add(JlabelFundoMenuIF);
        JlabelFundoMenuIF.setBounds(-10, 10, 490, 220);
        ...
        jComboBoxListaSetor.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "SELECIONE", "ADMINISTRATIVO", "NÚCLEO DE TI", "NUTRIÇÃO", "PEDAGÓGICO", "PSICOLOGIA", "SERVIÇO SOCIAL" }));
        ...
        jLabelPlaca.setText("Veículo:");
        getContentPane().add(jLabelPlaca);
        jLabelPlaca.setBounds(390, 40, 60, 25);
        ...
        jLabelPlacaObr.setBounds(400, 40, 20, 20);
        ...
        jButtonSalvaDestino.setBounds(360, 210, 30, 25);
        ...
        jLabelDestObr.setBounds(40, 210, 20, 25);
        ...
        jLabelFundo.setBounds(-10, 20, 930, 400);
    ...
    private void jButtonBuscarPlacaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonBuscarPlacaActionPerformed
        PreencherTabelaVeiculoIF("select a.placa, b.descricao, c.descricaomarca as desc from tbl_veiculo as a inner join tbl_modelo as b "
    ...
    private void jButtonSalvaDestinoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSalvaDestinoActionPerformed
     ...
     public void PreencherTabela(String SQL){
      ...
      jTableRegAtv.getColumnModel().getColumn(2).setPreferredWidth(120);
      ...
      jTableRegAtv.getColumnModel().getColumn(3).setPreferredWidth(227);
    ...
    public void PreencherTabelaVeiculoIF(String SQL){
      ArrayList dados = new ArrayList();
      ...
      jTableRegAtv.getTableHeader().setReorderingAllowed(false); //não reordenavel
      jTableRegAtv.setAutoResizeMode(jTableBuscaVeiculo.AUTO_RESIZE_OFF); //não redmencionar
      jTableRegAtv.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);//selicioar um dado por vez
    } 
